...
const u8 gText_ButtonMode[] = _("AUTORUN");
...
//const u8 gText_FishedItemX[] = _("Caught {STR_VAR_1} instead!{PAUSE_UNTIL_PRESS}");
const u8 gText_FishedItem[] = _("Reeled in an item instead!{PAUSE_UNTIL_PRESS}");
